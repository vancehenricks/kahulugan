  ...
  modal.innerHTML = `
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>Statutes, issuances, and court decisions are works of the Philippine Government. Kahulugan is not affiliated with, sponsored by, or endorsed by extra.bayanwat.ch, the Arellano Law Foundation, or the Lawphil Project.</p>
      </div>
      <div class="modal-footer">
